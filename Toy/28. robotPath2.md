...
const robotPath2 = function (room, src, sDir, dst, dDir) {
    ...
    function BFS(arr) {
      ...
      while (queue.length > 0) {
        ...
        if (dir === 1) {
          queue.push([Y-1, X, dir, count, checkDir]);         
          queue.push([Y, X+1, dir+1, count+1, checkDir+1]);   
          queue.push([Y+1, X, dir+2, count+2, checkDir+1]);   
          queue.push([Y, X-1, dir+3, count+1, checkDir+1]);   
        } 
        else if (dir === 2) {
          queue.push([Y-1, X, dir-1, count+1, checkDir+1]);
          queue.push([Y, X+1, dir, count, checkDir]);         
          queue.push([Y+1, X, dir+1, count+1, checkDir+1]);   
          queue.push([Y, X-1, dir+2, count+2, checkDir+1]);   
        } 
        else if (dir === 3) {
          queue.push([Y-1, X, dir-2, count+2, checkDir+1]);
          queue.push([Y, X+1, dir-1, count+1, checkDir+1]);   
